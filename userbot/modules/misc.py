...
async def killdabot(event):
    ...
    await event.edit("`Menonaktifkan DAPA-UBOT....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`DAPA-UBOT Telah Dinonaktifkan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting DAPA-UBOT...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`DAPA-UBOT Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[DAPA-UBOT Repo](https://github.com/Daffansaa/DAPA-UBOT/blob/DAPA-UBOT/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "**╭✠╼━━━━━━❖━━━━━━━✠╮** \n┣•REPO         : [👽𝐃𝐀𝐏𝐀-𝐔𝐁𝐎𝐓👽](https://github.com/Daffansaa/DAPA-UBOT)\n┣•PEMILIK    : [𝗗𝗮𝗳𝗳𝗮𝗻𝘀𝗮𝗮](t.me/MadBoyys)\n┣•CHANNEL : [𝐈𝐍𝐅𝐎](t.me/DapaUbotInfo)\n┣•GROUP      : [𝐆𝐑𝐎𝐔𝐏](t.me/ootspambot) \n**╰✠╼━━━━━━❖━━━━━━━✠╯**"
    )
